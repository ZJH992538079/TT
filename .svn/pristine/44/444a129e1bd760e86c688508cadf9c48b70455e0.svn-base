...
<div class="container">
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<c:forEach var="x" items="${LUNBO}" begin="0" step="1"
					   varStatus="status">
			...
			<div class="carousel-item active">
				...
				<div class="carousel-item ">
					...
					<a href="commentPage.do?id=${x.id }"><img src="${x.cover}" style="width: 1200px; height: 400px"></a>
					<div class="carousel-caption">
						<a href="commentPage.do?id=${x.id }"><h3>${x.title }</h3></a>
					</div>
				</div>
				</c:forEach>
			</div>
		...
		<div class="row" id="MyWord">
			<%-- <div class="col-sm-6 col-md-4" >
				<div class="thumbnail" >
					<input type="hidden" value="${k.id }"> <img
						src="${k.cover }">
					<div class="caption">
						<h3>${k.title }</h3>
					</div>
				...
				$.ajax({
					...
					success: function (res) {
						...
						for (i = 0; i < res.length; i++) {
							html += "<div class='col-sm-6 col-md-4' ><div class='thumbnail form_img' ><a href='commentPage.do?id=" + res[i].id + "'> <img src=" + res[i].cover + "></a><div class='caption'><a href='commentPage.doml?id=" + res[i].id + "'><h3>" + res[i].title + "</h3></a></div></div></div>";
						}
						$("#MyWord").html(html);
					}
				});
