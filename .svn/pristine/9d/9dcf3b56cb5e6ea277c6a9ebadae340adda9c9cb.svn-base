	...
	<div class="container" style="margin-top: 20px">
		...
		<div class="media">
			...
			<div class="media-body" style="font-size: 20px;">
				<!-- 标题 -->
				<h4 id="forum_title" class="media-heading"
					style="margin: 30px 0;margin-left:20px;font-size: 33px">${ONEFORUM.title!""}</h4>
		...
		<div class="clear">
			<div class="row" style="width: 90%;margin: 0 auto; margin-top: 20px">
				<div class="input-group col-11">
					<textarea id="comment_value"
							  style="width: inherit;height: 120px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</textarea>
				</div>
				<div class="align-self-end" style="border-radius:25px">
					<button onclick="insertcomment()" class="btn btn-primary" type="button;">提交</button>
				</div>
			</div>
		</div>
