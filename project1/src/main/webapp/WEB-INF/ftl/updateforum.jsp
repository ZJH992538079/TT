	...
	<body>
		...
		<div class="container" style="padding-bottom: 15px;">
			<div class="row">
				<div class="col col-lg-12">
					<form>
						<span class="d-none" id="forum_id">${forum.id}</span>
						<div class="form-group">
							<span>标题</span>
							<input type="text" class="form-control" id="form_title" value="${forum.title!'未知'}">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-primary" onclick="doUpdateForum()">保存</button>
					</div>
				</div>
			</div>
		</div>
